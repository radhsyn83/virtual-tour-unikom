<div id="menu-content" class="container h-100 p-0  animated fadeIn">
	<div class="row align-items-center h-100">
		<div class="see-more col-md-5 col-12 order-md-1 order-2">
			<h4>Acara</h4>
			<a href="#" onclick="showBeritaModal()">Selengkapnya</a>
		</div>
						...
						<div class="card bg-transparent text-white" style="height: 200px">
							<div class="img-bg h-100 w-auto"
								...
								<div class="img-title card-img-bottom">
									<span class="card-title">Tindak Lanjut Penjajakan Kerjasama : Unikom Bangun Kolaborasi dengan SEGi University and Colleges
								</div>
							</div>
						</div>
...
<!-- Modal -->
<div class="modal fade" id="beritaModal" tabindex="-1" role="dialog" aria-labelledby="menuModalLabel" aria-hidden="true">
