...
<div class="main">
	...
	<div class="main-body">
		...
		<div class="btn-group" role="group">
			<button type="button" id="pembayaran" class="btn btn-light active">Pembayaran</button>
			<button type="button" id="laporan" class="btn btn-light">Laporan</button>
		</div>
	...
	<script>
        ...
        $('#pembayaran').click(function () {
            menuOpen($(this), "pembayaran");
        });
        $('#laporan').click(function () {
            menuOpen($(this), "laporan");
        });

        function menuOpen(identity, menu) {
            let url = "<?= base_url('kasir/') ?>"+menu;
            console.log(url);
            $.ajax({
                url: url,
